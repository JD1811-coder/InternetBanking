    ...
    <div class="col-md-6 form-group">
        ...
        <input type="text" name="aadhar_number" id="aadhar_number" class="form-control" pattern="[0-9]{12}" required>
        <small class="text-danger" id="aadharError"></small>
    </div>
    <div class="col-md-6 form-group">
        <label>PAN Card Number</label>
        <input type="text" name="pan_number" id="pan_number" class="form-control" pattern="[A-Z]{5}[0-9]{4}[A-Z]{1}" required>
    ...
    // PAN validation
    let pan = document.getElementById("pan_number").value;
    let panRegex = /^[A-Z]{5}[0-9]{4}[A-Z]{1}$/;
    if (!panRegex.test(pan)) {
        document.getElementById("panError").innerText = "Invalid PAN number format.";
        isValid = false;
    } else {
